...
###Load information, you shuold activate one of the following 6 lines and update the names in lines 19 and 22 for the corresponding distribution error
...
## list for Estimation of the selected distribution
repl_estimation<-repl_laplace_estimation

##Flist for forecasting n.ahead with selected distribution
repl<-repl_laplace
